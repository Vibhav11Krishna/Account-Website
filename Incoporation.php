...
<head>
  ...
  <title>Business Incorporation & Strategic Structuring</title>
  <meta name="description" content="Start your business right. Quick and compliant registration for Companies, LLPs, and Partnerships with complete legal support.">
    ...
    <div class="container-premium">
      ...
      <div class="section-intro">
        <div class="service-box-tag">
          <span class="s-num">Service 01</span>
          <span class="s-name">Growth & Strategy</span>
        </div>
        <h2>Business Incorporation & <br><span class="text-navy">Strategic</span> <span class="text-orange">Structuring</span></h2>
      ...
      <div class="premium-grid">
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Registration.jpg" alt="Entity Registration">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-building"></i></div>
          <div class="card-details">
            <h4>Company & LLP Registration</h4>
            <p>Incorporation of Companies and LLPs with complete legal and regulatory compliance.</p>
          </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Partnership.jpg" alt="Startup India">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-handshake"></i></div>
          <div class="card-details">
            <h4>Partnership Setup</h4>
            <p>Formation of partnerships and proprietorships tailored to small and growing businesses</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Startup.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-rocket"></i></div>
          <div class="card-details">
            <h4>Startup India & MSME</h4>
            <p>Registration under government schemes to access benefits, incentives, and recognition</p>
          </div>
          <div class="hover-border"></div>
        </div>
         ...
         <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Statutory.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-id-card"></i></div>
          <div class="card-details">
            <h4>Statutory Registrations</h4>
            <p>Assistance with PAN, TAN, GST, and Digital Signature Certificates</p>
          </div>
          <div class="hover-border"></div>
        </div>
         ...
         <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Capital.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-chart-pie"></i></div>
          <div class="card-details">
            <h4>Capital & Shareholding Structuring</h4>
            <p>Advisory on ownership structure, capital planning, and shareholder arrangements</p>
          </div>
          <div class="hover-border"></div>
        </div>
         ...
         <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Business.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-arrows-rotate"></i></div>
          <div class="card-details">
            <h4>Business Conversion & Restructuring</h4>
            <p>Support for entity conversion, restructuring, and reorganization</p>
          </div>
          <div class="hover-border"></div>
        </div>
      </div>
    ...
    <div class="container-premium">
        ...
        <div class="process-wrapper">
            <div class="process-step">
                ...
                <h4>Consult & Assess </h4>
                <p>Understand business objectives, promoters, and structure requirements</p>
            ...
            <div class="process-step">
                ...
                <p>Recommend the most suitable legal and tax-efficient structure.</p>
                <div class="step-arrow"><i class="fas fa-chevron-right"></i></div>
            </div>
            ...
            <div class="process-step">
                ...
                <h4>Execute & Register </h4>
                <p>Complete incorporation, filings, and statutory registrations</p>
                <div class="step-arrow"><i class="fas fa-chevron-right"></i></div>
            </div>
            ...
            <div class="process-step">
                ...
                <h4>Handover & Guide </h4>
                <p>Deliver documents and guide on post-incorporation compliance</p>
            </div>
        </div>
    </div>
</section>
      ...
      <div class="checklist-section">
        <div class="checklist-inner">
          <div class="checklist-header">
            <h3>Pre-Incorporation <span class="text-orange">Checklist</span></h3>
            <p>Essential documents required to initiate the registration process.</p>
          </div>
          <div class="checklist-grid">
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>PAN & Aadhaar of Directors</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Passport size Photographs</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Registered Office Proof</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Specimen Signature (DSC)</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Identity Proof (Voter ID/DL)</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>NOC from Property Owner</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="faq-wrap">
        ...
        <div class="faq-box">
          <div class="faq-top">
            <span>How long does the registration take?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>The standard timeline is 7–15 working days, depending on government processing cycles.</p>
          </div>
        </div>
        <div class="faq-box">
          <div class="faq-top">
            <span>What is the minimum capital required?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>There is no mandatory minimum. You can start with as little as ₹1,000, though ₹1 Lakh is standard for authorized capital.</p>
          </div>
        </div>
        <div class="faq-box">
          <div class="faq-top">
            <span>Can a NRI or Foreign National be a Director?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, foreign nationals can be directors in an Indian Company. However, at least one director must be a resident of India (stayed in India for 182+ days in the previous calendar year).</p>
          </div>
        </div>

        <div class="faq-box">
          <div class="faq-top">
            <span>What are the tax benefits of Startup India registration?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Eligible startups can avail of a 3-year income tax holiday (80-IAC), exemption from Angel Tax (Section 56), and significantly reduced costs for patent and trademark filings.</p>
          </div>
        </div>

        <div class="faq-box">
          <div class="faq-top">
            <span>What criteria should I follow for choosing a company name?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>The name must be unique, not similar to existing trademarks, and must include a 'prefix' that reflects your business activity and a 'suffix' like (P) Ltd or LLP.</p>
          </div>
        </div>
      </div>
      ...
      <div class="navy-orange-banner">
        <div class="banner-content">
          <div class="banner-left">
            <h3>Ready to Structure Your Business?</h3>
            <p>Consult with CMA Karunesh Kumar for expert legal and tax structuring.</p>
          </div>
