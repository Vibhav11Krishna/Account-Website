...
<html lang="en">
<head>
    <title>Document Center | KKA</title>
    ...
    <style>
        ...
        /* The Magic Trick: Pushes the next element to the bottom */
        .logout-link { 
            margin-top: auto; 
        ...
        input, select { width:100%; padding:12px; margin:10px 0 20px; border:1.5px solid #e2e8f0; border-radius:10px; }
...
<body>
    <div class="sidebar">
        ...
        <a href="upload-docs.php" class="active"><i class="fas fa-cloud-upload-alt"></i> Document Center</a>
