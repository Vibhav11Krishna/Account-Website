...
<head>
    ...
    <style>
        ...
        th { text-align:left; padding:18px; background:#f8fafc; color:var(--navy); font-weight: 700; text-transform: uppercase; font-size: 12px; letter-spacing: 0.5px; }
        td { padding:18px; border-bottom:1px solid #f1f5f9; color: #475569; font-size: 14px; }
        ...
        .reset-form input { padding: 8px 12px; border: 1px solid #e2e8f0; border-radius: 8px; outline: none; transition: 0.3s; width: 140px; }
        .reset-form input:focus { border-color: var(--navy); }
        .btn-update { background: var(--navy); color: white; border: none; padding: 8px 15px; border-radius: 8px; cursor: pointer; font-weight: 600; font-size: 12px; }
        
        .delete-link { color: var(--danger); text-decoration: none; font-weight: 600; transition: 0.3s; }
