    ...
    <div class="container-premium">
      ...
      <div class="section-intro">
        <div class="service-box-tag">
          <span class="s-num">Service 02</span>
          <span class="s-name">Manage & Finance</span>
        </div>
        <h2>Accounting & <br><span class="text-navy">Financial</span> <span class="text-orange">Management</span></h2>
        <div class="dual-accent">
          <span class="bar-navy"></span>
          <span class="bar-orange"></span>
        </div>
        <p class="desc-text">
          We deliver accurate, timely, and transparent accounting solutions that support informed decision-making. Our services help businesses maintain financial discipline, improve control, and gain clear visibility into performance
        </p>
      </div>
      ...
      <div class="premium-grid">
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Bookkeeping.jpg" alt="Entity Registration">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-book"></i></div>
          <div class="card-details">
            <h4>Bookkeeping & Ledger</h4>
            <p>Systematic recording of daily financial transactions</p>
          </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Financial.jpg" alt="Startup India">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-file-lines"></i></div>
          <div class="card-details">
            <h4>Financial Statements</h4>
            <p>Preparation of Balance Sheet, Profit & Loss, and Cash Flow Statements</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Reporting.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-chart-column"></i></div>
          <div class="card-details">
            <h4>MIS & Management Reporting</h4>
            <p>Customized financial reports to support decision-making</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Budgeting.jpg" alt="Startup India">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-bullseye"></i></div>
          <div class="card-details">
            <h4>Budgeting & Forecasting</h4>
            <p>Financial planning for cost control and growth management</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Payroll.jpg" alt="Startup India">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-users-gear"></i></div>
          <div class="card-details">
            <h4>Payroll Processing</h4>
            <p>End-to-end payroll management with statutory compliance</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Bank.jpg" alt="Startup India">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-arrows-rotate"></i></div>
          <div class="card-details">
            <h4>Bank & Account Reconciliations</h4>
            <p>Regular reconciliation of bank and ledger accounts</p>
          </div>
          <div class="hover-border"></div>
        </div>
      </div>
        ...
        <div class="container-premium">
          ...
          <div class="process-wrapper">
            <div class="process-step">
              ...
              <p>Assess transaction volume, reporting needs, and systems</p>
            ...
            <div class="process-step">
              ...
              <h4>Setup & Onboard</h4>
              <p>Configure accounting processes and onboard financial data</p>
              <div class="step-arrow"><i class="fas fa-chevron-right"></i></div>
            </div>
            ...
            <div class="process-step">
              ...
              <h4>Manage & Record</h4>
              <p>Perform bookkeeping, reconciliations, and payroll processing</p>
              <div class="step-arrow"><i class="fas fa-chevron-right"></i></div>
            </div>
            ...
            <div class="process-step">
              ...
              <h4>Report & Review </h4>
              <p>Share periodic reports and conduct management reviews</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div class="checklist-section">
        <div class="checklist-inner">
          <div class="checklist-header">
            <h3>Pre-Finance <span class="text-orange">Checklist</span></h3>
            <p>Essential documents required to initiate the Accounting process.</p>
          </div>
          <div class="checklist-grid">
            <div class="check-item"><i class="fas fa-check-circle"></i> <span> Bank statements</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Sales & purchase invoices</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Expense bills and vouchers</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Payroll details and employee records</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>GST returns and filings </span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Access to accounting software or ERP (if any)</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="faq-wrap">
        ...
        <div class="faq-box">
          <div class="faq-top">
            <span>Do you provide complete bookkeeping services?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we offer end-to-end bookkeeping and accounting support</p>
          </div>
        </div>
        <div class="faq-box">
          <div class="faq-top">
          ...
          <div class="faq-btm">
            <p>Reports can be provided monthly, quarterly, or as per your requirement</p>
          </div>
        </div>
        <div class="faq-box">
          <div class="faq-top">
            <span>Can you work with our existing accounting software?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we work with most standard accounting and ERP systems</p>
          </div>
        </div>
        <div class="faq-box">
          <div class="faq-top">
            <span>Do you manage payroll and salary compliance?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we handle payroll processing and related statutory compliances</p>
          </div>
        </div>
        <div class="faq-box">
          <div class="faq-top">
            <span>Is my financial data kept confidential?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Absolutely. We follow strict confidentiality and data security practices.</p>
          </div>
        </div>
      </div>
      ...
      <div class="navy-orange-banner">
        <div class="banner-content">
          <div class="banner-left">
            <h3>Ready to Finance Your Business?</h3>
            <p>Consult with CMA Karunesh Kumar for expert Finanace and Accounting Management.</p>
          </div>
