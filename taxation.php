...
<head>
  ...
  <title>Taxation & Regulatory Advisory</title>
<meta name="description" content="Expert GST filing, Income Tax planning, and corporate tax compliance services by Karunesh Kumar & Associates. Minimize your tax liability today.">
    ...
    <div class="container-premium">
      ...
      <div class="section-intro">
        <div class="service-box-tag">
          <span class="s-num">Service 04</span>
          <span class="s-name">Taxation & Regulatory</span>
        </div>
        <h2>Taxation & <br><span class="text-navy">Regulatory</span> <span class="text-orange">Advisory</span></h2>
        <div class="dual-accent">
          <span class="bar-navy"></span>
          <span class="bar-orange"></span>
        </div>
        <p class="desc-text">
         We offer comprehensive tax compliance, planning, and representation services to ensure tax efficiency and regulatory adherence. Our advisory approach helps businesses manage risks while optimizing their tax position.
        </p>
      </div>
      ...
      <div class="premium-grid">
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/GST1.jpg" alt="Entity Registration">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-receipt"></i></div>
          <div class="card-details">
            <h4>GST Compliance & Returns</h4>
            <p>Filing of GST returns and handling GST compliance</p>
          </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Incometax.jpg" alt="Startup India">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-file-invoice"></i></div>
          <div class="card-details">
            <h4>Income Tax Returns</h4>
            <p>Preparation and filing of income tax returns</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Taxaudit.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-clipboard-check"></i></div>
          <div class="card-details">
            <h4>Tax Audit</h4>
            <p>Conduct of tax audits under applicable laws</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Taxplanning.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-lightbulb"></i></div>
          <div class="card-details">
            <h4>Tax Planning Advisory</h4>
            <p>Strategic planning to optimize tax liabilities</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Assessment.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-magnifying-glass-dollar"></i></div>
          <div class="card-details">
            <h4>Assessment & Scrutiny Support</h4>
            <p>Handling of tax notices and departmental assessments</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Appeals.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-scale-balanced"></i></div>
          <div class="card-details">
            <h4>Appeals & Representation</h4>
            <p>Representation before tax authorities and appellate forums</p>
          </div>
          <div class="hover-border"></div>
        </div>
      </div>
    ...
    <div class="container-premium">
        ...
        <div class="process-wrapper">
            <div class="process-step">
                ...
                <h4>Analyze Tax Position </h4>
                <p>Review financials and tax applicability</p>
            ...
            <div class="process-step">
                ...
                <h4>Collect & Prepare </h4>
                <p>Gather data and compute tax liabilities.</p>
                <div class="step-arrow"><i class="fas fa-chevron-right"></i></div>
            </div>
            ...
            <div class="process-step">
                ...
                <h4>File & Comply </h4>
                <p>File returns, audits, and statutory reports</p>
                <div class="step-arrow"><i class="fas fa-chevron-right"></i></div>
            </div>
            ...
            <div class="process-step">
                ...
                <h4>Support & Represent </h4>
                <p>Handle notices, assessments, and representations</p>
            </div>
        </div>
    </div>
</section>
      ...
      <div class="checklist-section">
        <div class="checklist-inner">
          <div class="checklist-header">
            <h3>Pre-Taxation <span class="text-orange">Checklist</span></h3>
            <p>Essential documents required to initiate the Taxation process.</p>
          </div>
          <div class="checklist-grid">
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>PAN of entity and promoters</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Aadhaar details (where applicable)</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Income details and financial statements</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>GST returns and challans</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Tax computation and previous returns</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Notices, orders, or communications from tax authorities</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="faq-wrap">
        ...
        <div class="faq-box">
          <div class="faq-top">
            <span>Do you handle both GST and Income Tax compliances?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we manage GST and Income Tax filings, audits, and advisory</p>
          </div>
        </div>
        <div class="faq-box">
          <div class="faq-top">
            <span>Can you assist with tax planning?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we provide lawful tax planning strategies tailored to your business</p>
          </div>
        </div>

        <div class="faq-box">
          <div class="faq-top">
            <span>Do you handle tax notices and assessments?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we assist in replying to notices, assessments, and scrutiny cases</p>
          </div>
        </div>

        <div class="faq-box">
          <div class="faq-top">
            <span>Will you represent us before tax authorities?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we provide representation before tax authorities and appellate forums</p>
          </div>
        </div>

        <div class="faq-box">
          <div class="faq-top">
            <span>How do you ensure timely tax compliance?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>We maintain compliance calendars and reminders to meet all due dates</p>
          </div>
        </div>
      </div>
      ...
      <div class="navy-orange-banner">
        <div class="banner-content">
          <div class="banner-left">
            <h3>Ready to Regulate Your Business?</h3>
