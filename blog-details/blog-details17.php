...
<head>
  ...
  <title>Key Labour Law Updates | Karunesh Kumar & Associates</title>

  <meta name="description" content="Understanding recent labour law changes and their implications for employers">

  <link rel="icon" href="../assets/CMA.jpg" type="image/jpeg">
  <link rel="apple-touch-icon" href="../assets/CMA.jpg">

  <meta property="og:title" content="Key Labour Law Updates | Karunesh Kumar & Associates">
  <meta property="og:description" content="Understanding recent labour law changes and their implications for employers">
  <meta property="og:image" content="https://cmakkassociates.com/assets/CMA.jpg">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://cmakkassociates.com/blog-details/blog-details17.php">
...
<body>
  ...
  <body>
    <main class="blog-article">
      <div class="content-padding" style="padding-bottom: 0;">
        <nav class="breadcrumb">
          ...
          <span class="sep">›</span>
          <span class="current">Key Labour Law Updates</span>
        </nav>
      </div>
    ...
    <div class="main-layout">
      ...
      <main class="blog-article">
        <div class="blog-hero" style="background-image: linear-gradient(rgba(5, 25, 55, 0.8), rgba(5, 25, 55, 0.8)), url('../assets/blog17.jpg');">
          <span class="category-label">Legal Updates</span>
          <h1>Key Labour Law Updates Employers Must Comply</h1>
          <p>Critical regulatory changes every employer in India should know and implement</p>
        </div>
       ...
       <div class="content-padding">
          <nav class="toc-box">
            ...
            <ul>
              <li><a href="#transition">Transition to Four Unified Labour Codes</a></li>
              <li><a href="#expanded">Expanded Workforce Coverage and Wages</a></li>
              <li><a href="#social">Social Security and Employee Benefits</a></li>
          ...
          <div class="blog-body">
            <section id="summary">
              <p>India’s labour law framework has recently undergone one of its most significant transformations in decades. The Government has implemented four consolidated labour codes that replace 29 older labour laws, while also introducing new rules on wages, social security, working conditions, and industrial relations. Employers need to be aware of these updates because they affect everything from hiring and contracts to payroll, employee benefits, workplace safety, and statutory compliance deadlines. </p>
              <p>This article outlines key labour law developments and practical compliance requirements that employers must focus on.</p>
            </section>

            <section id="transition">
              <h2>Transition to Four Unified Labour Codes</h2>
              <p>From <strong>21 November 2025</strong>, India has officially replaced 29 central labour laws with four major labour codes — the Code on Wages, the Industrial Relations Code, the Social Security Code, and the Occupational Safety, Health & Working Conditions Code. These codes aim to simplify compliance by streamlining different provisions under a unified framework. Employers must now align their HR, payroll, and compliance systems with these codes, even as supporting rules are being finalized by central and state authorities. </p>
              <p>This fundamental shift impacts how wages are defined, how employers hire and manage workers, and how compliance is reported.</p>
            </section>


            <section id="expanded">
              <h2>Expanded Workforce Coverage and Wages</h2>
              <p>The new labour regime introduces a standard definition of “wages” across all laws, which directly affects payroll structuring, overtime, PF, gratuity, and bonus calculations. Fixed-term employment has been legally recognised, and those workers are now entitled to benefits similar to permanent employees — including gratuity after just one year of service. Employers should revisit compensation structures and contract terms to ensure compliance with these definitions and entitlements.</p>
              <p>Minimum wages now apply universally across sectors, and higher overtime rates must be paid when employees work beyond regulated hours. </p>
            </section>

             <section id="social">
              <h2>Social Security and Employee Benefits</h2>
              <p>One of the most impactful updates under the new Social Security Code is the expanded coverage of social security benefits to gig workers, platform workers, and informal sector employees. Employers and aggregators engaging such workers must document contracts correctly and make required contributions, even if these individuals are not traditional full-time employees. </p>
              <p>Additionally, statutory benefits such as provident fund, ESI, annual health checks for workers over a certain age, and maternity benefits have been clarified — requiring employers to update their payroll and HR compliance systems. </p>
            </section>
