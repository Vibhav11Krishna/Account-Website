...
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap" rel="stylesheet">
  ...
  <main class="pp-wrapper">
    <div class="pp-card">
        <div class="pp-header">
            <div class="pp-icon-main"><i class="fa-solid fa-hand-holding-dollar"></i></div>
        ...
        <div class="pp-intro">
            <p>At Karunesh Kumar & Associates, we prioritize the security of your financial data and personal identity with enterprise-grade confidentiality and transparent data practices. Our data practices are designed in strict accordance with the Information Technology Act and Indian professional ethics to ensure your digital footprint remains secure.</p>
        </div>

        <div class="pp-body">
            
            <section class="pp-section">
                <h3><i class="fa-solid fa-clock-rotate-left"></i> 1. Cancellation Window</h3>
                <p>Requests for cancellation are accepted only within 24 hours of payment, provided no professional work (like DSC or Tax filing) has started.</p>
                </div>
            </section>

            <section class="pp-section">
                <h3><i class="fa-solid fa-gears"></i> 2. Service Commencement</h3>
                <p>Once documents are processed or filed with government portals (GST/IT/ROC), the service cannot be cancelled.</p>
            </section>

            <section class="pp-section">
                <h3><i class="fa-solid fa-circle-xmark"></i> 3. Non-Refundable Fees</h3>
                <p>Professional fees are non-refundable once consultancy is provided. Government taxes and statutory fees paid to authorities are strictly non-refundable</p>
            </section>

            <section class="pp-section">
                <h3><i class="fa-solid fa-copy"></i> 4. Technical Errors</h3>
                <p>If a client makes a duplicate payment due to a technical glitch, the extra amount will be refunded in full.</p>
            </section>

            <section class="pp-section">
                <h3><i class="fa-solid fa-building-columns"></i> 5. Refund Method</h3>
                <p>All approved refunds will be credited back to the original payment method (Bank/UPI/Card) used during the transaction.</p>
            </section>

            <section class="pp-section">
                <h3><i class="fa-solid fa-credit-card"></i> 6. Processing Time</h3>
                <p>Approved refunds will be processed within 7 to 10 business days as per banking norms.</p>
            </section>

            <section class="pp-section">
                <h3><i class="fa-solid fa-calendar-check"></i> 7. Digital Receipt</h3>
                <p>Since KKA provides professional services, "Payment" is confirmed when the final acknowledgment or Receipt is emailed or uploaded to the client portal.</p>
            </section>
