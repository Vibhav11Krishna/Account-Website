...
<head>
  ...
  <title>Corporate & Statutory Compilance</title>
 <meta name="description" content="Manage all your statutory and regulatory compliances without the stress. We handle the paperwork so you can run your business.">
    ...
    <div class="container-premium">
      ...
      <div class="section-intro">
        <div class="service-box-tag">
          ...
          <span class="s-name">Corporate & Compilance</span>
        </div>
        <h2>Corporate & <br><span class="text-navy">Statutory</span> <span class="text-orange">Compilance</span></h2>
        <div class="dual-accent">
          <span class="bar-navy"></span>
          <span class="bar-orange"></span>
        </div>
        <p class="desc-text">
         We manage ongoing corporate and statutory compliance requirements to ensure uninterrupted operations. Our structured compliance management minimizes regulatory risks and keeps businesses aligned with legal obligations.
        </p>
      </div>
      ...
      <div class="premium-grid">
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Compilance1.jpg" alt="Entity Registration">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-building-columns"></i></div>
          <div class="card-details">
            <h4>ROC & MCA Filings</h4>
            <p>Routine and event-based corporate filings.</p>
          </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Compilance2.jpg" alt="Startup India">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-file-circle-check"></i></div>
          <div class="card-details">
            <h4>Annual Returns & Filings</h4>
            <p>Timely filing of annual returns for companies and LLPs</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Compilance3.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-id-badge"></i></div>
          <div class="card-details">
            <h4>Director Compliance Management</h4>
            <p>DIN, KYC, and director-related compliances</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Compilance4.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-book-open"></i></div>
          <div class="card-details">
            <h4>Statutory Registers Maintenance</h4>
        ...
        <div class="premium-card">
          ...
          <div class="card-details">
            <h4>Board & Shareholder Documentation</h4>
            <p>Preparation of resolutions and meeting records</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Compilance6.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-calendar-check"></i></div>
          <div class="card-details">
            <h4>Compliance Calendar & Monitoring</h4>
            <p>Tracking due dates and regulatory deadlines</p>
          </div>
          <div class="hover-border"></div>
        </div>
    ...
    <div class="container-premium">
        ...
        <div class="process-wrapper">
            <div class="process-step">
                ...
                <h4>Assess Compliance Needs </h4>
                <p>Identify applicable statutory requirements</p>
            ...
            <div class="process-step">
                ...
                <h4>Plan & Track</h4>
                <p>Create compliance calendar and due-date tracker</p>
                <div class="step-arrow"><i class="fas fa-chevron-right"></i></div>
            </div>
            ...
            <div class="process-step">
                ...
                <h4>Prepare & File </h4>
                <p>Complete ROC and statutory filings</p>
                <div class="step-arrow"><i class="fas fa-chevron-right"></i></div>
            </div>
            ...
            <div class="process-step">
                ...
                <h4>Monitor & Update </h4>
                <p>Ongoing compliance monitoring and reporting</p>
            </div>
        </div>
    </div>
</section>
      <div class="checklist-section">
        <div class="checklist-inner">
          <div class="checklist-header">
            <h3>Pre-Compilance <span class="text-orange">Checklist</span></h3>
            <p>Essential documents required to initiate the Compilance process.</p>
          </div>
          <div class="checklist-grid">
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Certificate of Incorporation</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>MOA & AOA / LLP Agreement</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>PAN of the entity</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Director / partner details and DIN</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Statutory registers and past filings</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Compliance calendar and due-date records</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="faq-wrap">
        ...
        <div class="faq-box">
          <div class="faq-top">
            <span>Do you manage complete ROC and MCA compliance?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we handle routine and event-based ROC and MCA filings</p>
          </div>
        </div>
        <div class="faq-box">
          <div class="faq-top">
            <span>How do you track compliance due dates?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>We maintain structured compliance calendars and monitoring systems</p>
          </div>
        </div>

        <div class="faq-box">
          <div class="faq-top">
            <span>Can you manage director-related compliances?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we manage DIN, KYC, disclosures, and director compliances</p>
          </div>
        </div>

        <div class="faq-box">
          <div class="faq-top">
            <span>Will you maintain statutory registers and records?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we maintain statutory registers as per legal requirements</p>
          </div>
        </div>

        <div class="faq-box">
          <div class="faq-top">
            <span>Do you provide ongoing compliance support?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we offer continuous compliance management services</p>
          </div>
        </div>
      </div>
      ...
      <div class="navy-orange-banner">
        <div class="banner-content">
          <div class="banner-left">
            <h3>Ready to Compile Your Business?</h3>
            <p>Consult with CMA Karunesh Kumar for expert in Compilance.</p>
          </div>
