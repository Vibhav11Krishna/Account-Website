    ...
    <div class="container-premium">
      ...
      <div class="section-intro">
        <div class="service-box-tag">
          <span class="s-num">Service 05</span>
          <span class="s-name">Startup & MSMEs</span>
        </div>
        <h2>Startup & <br><span class="text-navy">MSMEs</span> <span class="text-orange">Advisory Services</span></h2>
        <div class="dual-accent">
          <span class="bar-navy"></span>
          <span class="bar-orange"></span>
        </div>
        <p class="desc-text">
          We support startups and MSMEs with end-to-end advisory services designed for growth and sustainability. From setup and compliance to funding and performance improvement, we provide practical and scalable solutions.
        </p>
      </div>
      ...
      <div class="premium-grid">
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Startup1.jpg" alt="Entity Registration">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-lightbulb"></i></div>
          <div class="card-details">
            <h4>Startup Advisory & Handholding</h4>
            <p>End-to-end support from idea to operations</p>
          </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Startup2.jpg" alt="Startup India">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-screwdriver-wrench"></i></div>
          <div class="card-details">
            <h4>Accounting Setup for Startups</h4>
            <p>Design and implementation of accounting systems</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Startup3.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-file-invoice-dollar"></i></div>
          <div class="card-details">
            <h4>Funding & Financial Projections</h4>
            <p>Preparation of projections and funding documentation</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Startup4.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-wallet"></i></div>
          <div class="card-details">
            <h4>Working Capital Advisory</h4>
            <p>Cash flow and liquidity management support</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          ...
          <div class="card-details">
            <h4>Cost Optimization Advisory</h4>
            <p>Review and improvement of cost structures</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Startup7.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-landmark"></i></div>
          <div class="card-details">
            <h4>Subsidy & Government Scheme Support</h4>
            <p>Assistance with incentives and subsidy applications</p>
          </div>
          <div class="hover-border"></div>
        </div>
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Project.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-file-lines"></i></div>
          <div class="card-details">
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Assistance.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
          <div class="card-icon-float"><i class="fa-solid fa-hand-holding-dollar"></i></div>
          <div class="card-details">
        ...
        <div class="premium-card">
          <div class="card-image-box">
            <img src="assets/Pitch.jpg" alt="Equity Design">
            <div class="card-overlay"></div>
          </div>
    ...
    <div class="container-premium">
        ...
        <div class="process-wrapper">
            <div class="process-step">
                ...
                <p>Review business model, stage, and challenges</p>
            ...
            <div class="process-step">
                ...
                <p>Identify advisory, compliance, and funding needs</p>
                <div class="step-arrow"><i class="fas fa-chevron-right"></i></div>
            </div>
            ...
            <div class="process-step">
                ...
                <h4>Implement Support </h4>
                <p>Execute registrations, accounting, and compliance</p>
                <div class="step-arrow"><i class="fas fa-chevron-right"></i></div>
            </div>
            ...
            <div class="process-step">
                ...
                <h4>Review & Grow </h4>
                <p>Monitor performance and support growth initiatives</p>
            </div>
        </div>
    </div>
</section>
      ...
      <div class="checklist-section">
        <div class="checklist-inner">
          <div class="checklist-header">
            <h3>Pre-Startups & MSMEs <span class="text-orange">Checklist</span></h3>
            <p>Essential documents required to initiate the Startup & MSMEs process.</p>
          </div>
          <div class="checklist-grid">
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Business plan or concept note</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Incorporation documents</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Bank statements</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>MSME / Startup registration details </span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Funding or loan-related documents</span></div>
            <div class="check-item"><i class="fas fa-check-circle"></i> <span>Details of government schemes or subsidies applied</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="faq-wrap">
        ...
        <div class="faq-box">
          <div class="faq-top">
            <span>Do you support first-time entrepreneurs?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we provide complete handholding for new entrepreneurs</p>
          </div>
        </div>
        <div class="faq-box">
          <div class="faq-top">
            <span>Are your services suitable for small businesses?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, our services are scalable and cost-effective for startups and MSMEs</p>
          </div>
        </div>

        <div class="faq-box">
          <div class="faq-top">
            <span>Can you assist in funding and loan documentation?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we prepare financial projections and funding-related documents</p>
          </div>
        </div>

        <div class="faq-box">
          <div class="faq-top">
            <span>Do you help with government schemes and subsidies?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, we assist in applying for eligible government incentives and subsidies</p>
          </div>
        </div>

        <div class="faq-box">
          <div class="faq-top">
            <span>Will you support us as the business grows?</span>
            <i class="fas fa-plus"></i>
          </div>
          <div class="faq-btm">
            <p>Yes, our services evolve with your business growth and requirements</p>
          </div>
        </div>
      </div>
      ...
      <div class="navy-orange-banner">
        <div class="banner-content">
          <div class="banner-left">
            ...
            <p>Consult with CMA Karunesh Kumar for expert in Startup and MSMEs Advisory.</p>
          </div>
